...
<p><code>a[l] + a[l + 1] + ... + a[r - 1]</code> を返します。
<code>T</code> が整数型(<code>int / uint / ll / ull</code>)の場合、答えがオーバーフローしたならば $\bmod 2^{\mathrm{bit}}$ で等しい値を返します。</p>
<p><strong>制約</strong></p>
<ul>
